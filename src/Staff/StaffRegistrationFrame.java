...
public class StaffRegistrationFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBounds(660, 222, 626, 565);

        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Staff/pravara college1.jpg"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        else
        {
            ...
            if(rg.isStaffRegister(st, name.getText(), mob.getText(), email.getText(), id.getText(), jComboBox1.getSelectedItem().toString(), username.getText(), pass.getText()))
            {
            ...
            JOptionPane.showMessageDialog(null, "Error in Staff Registration ");
        }
